...
// include: /var/folders/7z/ng1g4mzx4x32wgr4v_mhtqgm0000gn/T/tmpvvc4_pgr.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'libraysnake/libraysnake.data';
      var REMOTE_PACKAGE_BASE = 'libraysnake.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_libraysnake/libraysnake.data');

      };
      Module['addRunDependency']('datafile_libraysnake/libraysnake.data');
    ...
    loadPackage({"files": [{"filename": "/resources/level1.txt", "start": 0, "end": 632}], "remote_package_size": 632});

  })();

// end include: /var/folders/7z/ng1g4mzx4x32wgr4v_mhtqgm0000gn/T/tmpvvc4_pgr.js
// include: /var/folders/7z/ng1g4mzx4x32wgr4v_mhtqgm0000gn/T/tmpbqrb46aw.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/7z/ng1g4mzx4x32wgr4v_mhtqgm0000gn/T/tmpbqrb46aw.js
// include: /var/folders/7z/ng1g4mzx4x32wgr4v_mhtqgm0000gn/T/tmpgxh3pw57.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/7z/ng1g4mzx4x32wgr4v_mhtqgm0000gn/T/tmpgxh3pw57.js
